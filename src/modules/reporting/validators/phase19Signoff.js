...
export const REQUIRED_REDIRECT_TARGETS = {
  ...
  supplier_reorder_report: { targetId: 'stock_control', view: 'supplier_reorder' },
...
export const REQUIRED_FINAL_REPORT_VIEWS = {
  ...
  stock_control: ['location_summary', 'category_summary', 'item_detail', 'reorder_detail', 'supplier_reorder', 'warnings'],
  ...
  wastage: ['summary', 'by_source', 'by_category', 'by_item', 'line_detail'],
  stock_take_audit: ['sessions', 'by_category', 'by_item', 'count_detail', 'variance_movements'],
  adjustments: ['summary', 'by_reason', 'by_category', 'by_item', 'line_detail'],
