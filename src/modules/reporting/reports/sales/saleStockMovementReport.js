...
const recipeLineDetailColumns = [
  ...
  { key: 'sourceType', label: 'Source Type', sortable: true },
  { key: 'stockMovementType', label: 'Movement', sortable: true },
...
const transactionDetailColumns = [
  ...
  { key: 'refundHandling', label: 'Refund Handling', sortable: true },
  { key: 'refundId', label: 'Refund ID', sortable: true },
  { key: 'stockQuantityChange', label: 'Stock Qty Change', type: 'number', align: 'right', sortable: true },
...
const movementExportMapping = {
  ...
  inventoryCategoryName: 'Inventory Category',
  sourceType: 'Source Type',
  stockMovementType: 'Movement',
  refundReason: 'Refund Reason',
  refundHandling: 'Refund Handling',
  refundId: 'Refund ID',
  stockQuantityChange: 'Stock Qty Change',
